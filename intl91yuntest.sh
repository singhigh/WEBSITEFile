...
echo "Input the Provider's name [default:Enter]"
read hostp
echo "Test start, ingore all Chinese if you don't understand."
#===============================以下是各类要用到的函数========================================
...
tracetest()
{
	...
	mtrgo "http://www.ipip.net/traceroute.php?as=1&a=get&n=1&id=20&ip=$IP" "ChinaTelecomCN2Xiamen"
...
backtracetest()
{
	...
	mtrback "117.28.254.129" "ChinaTelecomCN2Xiamen"
...
gotoping()
{
	...
	testping speedtest.tokyo.linode.com LinodeJP
	testping hnd-jp-ping.vultr.com VultrJP
	testping 192.157.214.6 BudgetvmLA
	testping downloadtest.kdatacenter.com kdatacenterSK
	testping 210.92.18.1 StarryDNSKoreaTelecom
...
updatefile()
{
	...
	echo If you are non-Chinese reader, use http://test.91yun.org/en/report?id=hash to read the test report.
}
